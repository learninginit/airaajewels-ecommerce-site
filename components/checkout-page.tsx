...
import { useCartStore, useOrdersStore, useAdminStore } from "@/lib/store"
...
export default function CheckoutPage() {
  ...
  const rentTotal = rentItems.reduce((sum, item) => sum + item.price * item.quantity * (item.rentDays || 1), 0)
